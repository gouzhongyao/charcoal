...
(async () => {
  try {
    ...
    try {
      ...
      db.prepare("INSERT INTO energy_records (energy_type_id, organization_unit_id, original_month, normalized_month, original_unit, original_value, normalized_unit, normalized_value, duplicate_key, record_status, created_at, updated_at) VALUES (?, ?, '2026-01', '2026-01', 'kWh', 1, 'kWh', 1, 'generation-execute-energy-boundary', 'active', datetime('now'), datetime('now'))").run(electricityId, unitId);
