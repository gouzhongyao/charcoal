...
function validateDemoArtifactRegistry() {
  if (DEMO_ARTIFACT_REGISTRY.length !== 25) throw new Error('演示 artifact 注册表必须恰好包含 25 项。');
  const keys = new Set();
