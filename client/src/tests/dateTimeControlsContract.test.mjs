...
const specializedDateContracts = new Map([
  ...
  ['views/carbon/components/CarbonEmissionReportsSection.vue|date|draftFilters.periodStart', 'YYYY-MM-DD'],
  ['views/carbon/components/CarbonEmissionReportsSection.vue|date|draftFilters.periodEnd', 'YYYY-MM-DD'],
  ['views/carbon/components/GhgReportsSection.vue|date|draftFilters.periodStart', 'YYYY-MM-DD'],
  ['views/carbon/components/GhgReportsSection.vue|date|draftFilters.periodEnd', 'YYYY-MM-DD'],
