...
@media (max-width:1200px){.summary-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.analysis-grid{grid-template-columns:1fr}.metric-row{grid-template-columns:repeat(2,minmax(0,1fr))}.warning-summary{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media (max-width:960px){.standard-grid{grid-template-columns:1fr}.standard-span-two{grid-column:span 1}.standard-header{grid-template-columns:1fr}.standard-controls{justify-content:flex-start}.summary-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.warning-list{grid-template-columns:1fr}.quick-links{align-items:flex-start;flex-direction:column}.quick-links__actions{justify-content:flex-start}}
@media (max-width:640px){.standard-header{padding:17px}.standard-controls{align-items:stretch;flex-direction:column}.standard-controls :deep(.el-select),.panel-select,.panel-select--small{width:100%}.summary-grid,.metric-row,.metric-row--compact,.warning-summary,.meter-status-grid,.import-grid{grid-template-columns:1fr}.warning-summary>div{border-right:0;border-bottom:1px solid var(--cockpit-table-border)}.warning-summary>div:last-child{border-bottom:0}}
