<template>
  <main class="immersive-dashboard">
    ...
    <section class="immersive-boundary" aria-labelledby="immersive-boundary-title">
      <div><span>CAPABILITY BOUNDARY</span><h2 id="immersive-boundary-title">未接入能力不参与摘要</h2></div>
      <p>没有权威数据源的能源成本、碳资产、实时遥测等能力不显示伪零或正常状态；完整说明保留在标准布局。</p>
    </section>
  </main>
</template>
